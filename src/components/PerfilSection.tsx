    ...
    <div className="left-content">
      ...
      <div className="about-section">
        ...
        <h2 className="about-text">
          Estudante do 6º período de Sistemas de Informação, minha jornada na área de tecnologia começou em 2022 e tem sido marcada por um aprendizado constante e pela busca por desafios que me façam crescer.
